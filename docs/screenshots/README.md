...
## 02-lab.png
Lab Overview — live stats (89 proofs, 20 agents), system health, use case distribution, connected contracts

## 03-proofs.png
Proof Registry — browsable table with agent, use case, Merkle root, mode, status, actions
