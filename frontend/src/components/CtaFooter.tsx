        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="https://github.com/githoboman/Bot-prove" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-7 py-3.5 border border-gray-700 text-gray-300 rounded-xl hover:border-red-500/40 hover:text-white transition-colors font-mono text-sm">
                git clone
              </a>
            </div>
