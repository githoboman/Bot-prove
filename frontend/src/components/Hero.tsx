        ...
        <div className="max-w-2xl">
          ...
          */}
          ...
          <div className="flex flex-wrap gap-4 mt-5 text-sm">
            ...
            <a href="https://github.com/githoboman/Bot-prove" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-gray-400 hover:text-gray-200 underline underline-offset-4 decoration-gray-700 hover:decoration-gray-500 transition-colors">
