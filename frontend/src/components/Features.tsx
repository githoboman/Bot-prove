...
const features = [
  ...
  { icon: Server, title: 'BOT Chain Anchoring', desc: 'Proof hashes and Merkle roots are stored across 9 smart contracts, all live on BOT Chain testnet. Immutable, timestamped records.' },
  { icon: Shield, title: 'Real ZK Proofs (Groth16, off-chain)', desc: 'BN254 Groth16 via gnark — real R1CS circuits, trusted setup, pairing-based verification run in the engine (not simulation). On-chain BOT Chain verifier for Groth16 is roadmap.' },
